...
python singleheader.py $d/include/stc/hmap.h    $d/../stcsingle/stc/hashmap.h
...
python singleheader.py $d/include/stc/hset.h    $d/../stcsingle/stc/hashset.h
python singleheader.py $d/include/stc/smap.h   $d/../stcsingle/stc/sortedmap.h
python singleheader.py $d/include/stc/cspan.h   $d/../stcsingle/stc/cspan.h
python singleheader.py $d/include/stc/sset.h   $d/../stcsingle/stc/sortedset.h
