...
#define i_keyclass  Viking  // key type    ; binds _drop, _clone (and _from, _toraw if i_cmpclass defined)
#define i_cmpclass  RawVik  // lookup type ; binds _cmp, _eq, _hash (unless overridden)
