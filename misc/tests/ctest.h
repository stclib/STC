...
#define EXPECT_STREQ(...) _CHECK_STREQ(1, __VA_ARGS__)
#define EXPECT_STRNE(...) _CHECK_STRNE(1, __VA_ARGS__)
#define EXPECT_SUBSTR(...) _CHECK_SUBSTR(1, __VA_ARGS__)
#define EXPECT_NOT_SUBSTR(...) _CHECK_NOT_SUBSTR(1, __VA_ARGS__)
#define EXPECT_WSTREQ(...) _CHECK_WSTREQ(1, __VA_ARGS__)
#define EXPECT_WSTRNE(...) _CHECK_WSTRNE(1, __VA_ARGS__)
#define EXPECT_EQ(...) _CHECK_EQ(1, __VA_ARGS__)
#define EXPECT_NE(...) _CHECK_NE(1, __VA_ARGS__)
#define EXPECT_LT(...) _CHECK_LT(1, __VA_ARGS__)
#define EXPECT_LE(...) _CHECK_LE(1, __VA_ARGS__)
#define EXPECT_GT(...) _CHECK_GT(1, __VA_ARGS__)
#define EXPECT_GE(...) _CHECK_GE(1, __VA_ARGS__)
#define EXPECT_INTERVAL(...) _CHECK_INTERVAL(1, __VA_ARGS__)
#define EXPECT_PTR_EQ(...) _CHECK_PTR_EQ(1, __VA_ARGS__)
#define EXPECT_PTR_NE(...) _CHECK_PTR_NE(1, __VA_ARGS__)
...
#define EXPECT_NEAR(...) _CHECK_NEAR(1, __VA_ARGS__)
#define EXPECT_NOT_NEAR(...) _CHECK_NOT_NEAR(1, __VA_ARGS__)
#define EXPECT_DOUBLE_EQ(...) _CHECK_DOUBLE_EQ(1, __VA_ARGS__)
#define EXPECT_DOUBLE_NE(...) _CHECK_DOUBLE_NE(1, __VA_ARGS__)
#define EXPECT_DOUBLE_LT(...) _CHECK_DOUBLE_LT(1, __VA_ARGS__)
#define EXPECT_DOUBLE_GT(...) _CHECK_DOUBLE_GT(1, __VA_ARGS__)
#define EXPECT_FLOAT_EQ(...) _CHECK_FLOAT_EQ(1, __VA_ARGS__)
#define EXPECT_FLOAT_NE(...) _CHECK_FLOAT_NE(1, __VA_ARGS__)
#define EXPECT_FLOAT_LT(...) _CHECK_FLOAT_LT(1, __VA_ARGS__)
#define EXPECT_FLOAT_GT(...) _CHECK_FLOAT_GT(1, __VA_ARGS__)

// ASSERT =====================================

#define ASSERT_STREQ(...) _CHECK_STREQ(2, __VA_ARGS__)
#define ASSERT_STRNE(...) _CHECK_STRNE(2, __VA_ARGS__)
#define ASSERT_SUBSTR(...) _CHECK_SUBSTR(2, __VA_ARGS__)
#define ASSERT_NOT_SUBSTR(...) _CHECK_NOT_SUBSTR(2, __VA_ARGS__)
#define ASSERT_WSTREQ(...) _CHECK_WSTREQ(2, __VA_ARGS__)
#define ASSERT_WSTRNE(...) _CHECK_WSTRNE(2, __VA_ARGS__)
#define ASSERT_EQ(...) _CHECK_EQ(2, __VA_ARGS__)
#define ASSERT_NE(...) _CHECK_NE(2, __VA_ARGS__)
#define ASSERT_LT(...) _CHECK_LT(2, __VA_ARGS__)
#define ASSERT_LE(...) _CHECK_LE(2, __VA_ARGS__)
#define ASSERT_GT(...) _CHECK_GT(2, __VA_ARGS__)
#define ASSERT_GE(...) _CHECK_GE(2, __VA_ARGS__)
#define ASSERT_INTERVAL(...) _CHECK_INTERVAL(2, __VA_ARGS__)
#define ASSERT_PTR_EQ(...) _CHECK_PTR_EQ(2, __VA_ARGS__)
#define ASSERT_PTR_NE(...) _CHECK_PTR_NE(2, __VA_ARGS__)
...
#define ASSERT_NEAR(...) _CHECK_NEAR(2, __VA_ARGS__)
#define ASSERT_NOT_NEAR(...) _CHECK_NOT_NEAR(2, __VA_ARGS__)
#define ASSERT_DOUBLE_EQ(...) _CHECK_DOUBLE_EQ(2, __VA_ARGS__)
#define ASSERT_DOUBLE_NE(...) _CHECK_DOUBLE_NE(2, __VA_ARGS__)
#define ASSERT_DOUBLE_LT(...) _CHECK_DOUBLE_LT(2, __VA_ARGS__)
#define ASSERT_DOUBLE_GT(...) _CHECK_DOUBLE_GT(2, __VA_ARGS__)
#define ASSERT_FLOAT_EQ(...) _CHECK_FLOAT_EQ(2, __VA_ARGS__)
#define ASSERT_FLOAT_NE(...) _CHECK_FLOAT_NE(2, __VA_ARGS__)
#define ASSERT_FLOAT_LT(...) _CHECK_FLOAT_LT(2, __VA_ARGS__)
#define ASSERT_FLOAT_GT(...) _CHECK_FLOAT_GT(2, __VA_ARGS__)
